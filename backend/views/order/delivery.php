...
<div class="box box-primary">
    ...
    ?>
        ...
        <div class="print"><a class="btn btn-primary btn-flat btn-xs" href="<?php echo Url::toRoute(['order/print','id'=>$model['id']]);?>"><i class="fa fa-print"></i>打印订单</a></div>
        <div class="order-container">
            <div class="list-item row">
                ...
                <div class="col-md-3">
                  ...
                  <div> <?=$form->field($delivery, 'shipping_code')->dropdownList($items,
    ['prompt'=>'请选择快递']
);?></div>
                </div>
                <div class="col-md-6">            
