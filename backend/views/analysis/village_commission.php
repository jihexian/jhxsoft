...
<div class="Analysis-distribut">
 ...
 -->    <div class="box box-primary">
        <div class="box-body">
				...
				<div class="form-group">
		        	<label style="font-weight: normal;">村点名：</label>
                    ...
                    'id',              
                     ...
                     [
                        ...
                        'buttons' => [
                                     ...
                                     return Html::a('<i class="fa fa-eye"></i>', null, ['class' => 'btn btn-xs btn-default','data-toggle' => 'tooltip','href'=>Url::to(['village-commission-log/index','village_id'=>$model->name]),'title' => '查看详情 ']);
                                     }
                           ]
