...
<div class="Analysis-distribut">
 ...
 -->    <div class="box box-primary">
        <div class="box-body">
		        ...
		        'action' => ['member-village-commission'],
		        'method' => 'get',
				...
				<div class="form-group">
		        	<label style="font-weight: normal;">用户名：</label>
                    ...
                    'id',              
                     ...
                     [
                        ...
                        'buttons' => [
                                     ...
                                     return Html::a('<i class="fa fa-eye"></i>', null, ['class' => 'btn btn-xs btn-default','data-toggle' => 'tooltip','href'=>Url::to(['village-commission-log/index','m_id'=>$model->username]),'title' => '查看详情 ']);
                                     }
                           ]
