	       ...
	       <canvas id="myChart" width="400" height="400"></canvas>
			...
			var myChart = new Chart(ctx, {
			    ...
			    data: {
			        ...
			        datasets: [{
			            label: '退款成功总额',
			            data: <?php echo json_encode($result['orderRefundAmount'],true);?>,
			            backgroundColor:'green',
			            borderColor:'green',
			            borderWidth: 1
			        },{
			            label: '退款成功订单总数',
			            data: <?php echo json_encode($result['orderRefundCount'],true);?>,
			            backgroundColor:'red',
			            borderColor:'red',
			            borderWidth: 1
			        },{
			            label: '待退款订单总额',
			            data: <?php echo json_encode($result['orderRefundUndoAmount'],true);?>,
			            backgroundColor:'blue',
			            borderColor:'blue',
			            borderWidth: 1
			        },{
			            label: '待退款订单总数',
			            data: <?php echo json_encode($result['orderRefundUndoCount'],true);?>,
