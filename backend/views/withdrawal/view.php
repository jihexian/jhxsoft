...
?>
   ...
   <section class="content">
    ...
    <div class="box-body">
    <table id="w0" class="table table-striped table-bordered detail-view"><tbody><tr><th>提现申请</th><td><?=$model->id?></td></tr>

        <tr><th>用户</th><td><?=$model['member']['username']?></td></tr>
        <tr><th>提款账号真实姓名</th><td><?=$model->realname?></td></tr>
        <tr><th>提现金额</th><td><?=$model->pay_amount?></td></tr>
        <tr><th>银行名称</th><td><?=$model->bank_name?></td></tr>
        <tr><th>银行账号</th><td><?=$model->bank_card?></td></tr>
        <tr><th>提款账号真实姓名</th><td><?=$model->realname?></td></tr>   
        ...
        <tr><th>处理时间</th><td><?php echo date('Y-m-d H:i:s',$model->updated_at);?></td></tr>
        <?php if($model->status==0):?> 
         <tr><th>操作备注</th><td>
        <textarea name="remark" id="remark" style="width:100%;height:80px;"><?=$model->remark?></textarea>
        </td></tr>
         ...
         <?php endif;?>
          ...
          <?php else:?> 
             <tr><th>操作备注</th><td><?=$model->remark?></td></tr>
             <tr><th>状态</th><td><?=$model->getStatus($model->status)?></td></tr>
         <?php endif;?>
