    ...
    public function fields()
    {
        return ArrayHelper::merge(parent::fields(), [
            ...
            'commentCount'=>function ($model) {
                return $model->getCommentTotal();
            },
            'voteCount'=>function ($model) {
                return $model->getUpTotal();
            },
            'isVote'=>function ($model) {
                return $model->getIsUp()? 1:0;
            },
            'isFavourite'=>function ($model) {
                return $model->getIsFavourite()? 1:0;
            },
