...
use Yii;
use common\behaviors\MemberBehavior;
...
class Comment extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['entity_id','member_id', 'user_id', 'parent_id', 'is_top', 'parent_id', 'reply_member_id'], 'integer'],
            [['content'], 'string'],
            //['content', 'setReplyUid'],
        	['reply_member_id', 'exist', 'targetClass' => Member::className(), 'targetAttribute' => 'id'],
...
//             //$replyUserId = Member::find()->select('id')->where(['username' => $replyUserName])->scalar();
//             $this->reply_member_id = $replyUserId;
//         }
//     }
    ...
    public function behaviors()
    {
        return [
            ...
            [
                ...
                'createdByAttribute' => 'member_id',
                'updatedByAttribute' => false
            ],
            VoteBehavior::className(),
            UserBehavior::className(),
        	MemberBehavior::className(),
//             [
...
//     }
    ...
    public function beforeSave($insert)
    {
        if (parent::beforeSave($insert)) {
            if ($insert == true) {
                if ($this->parent_id) {
                    $this->reply_member_id = $this->parent->member_id;
                }
